...
\begin{itemize}
	\item Cliente: la Ing. Renata Gorla será el cliente, comprometiendose a evaluar la propuesta de valor del proyecto y dar su feedback en las diferentes etapas del prototipo. Su principal interés es contar con una solución confiable, simple de usar y con un costo de adquisición y mantenimiento accesible.
