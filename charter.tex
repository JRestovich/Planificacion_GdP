...
\begin{itemize}
	\item Severidad (S): 7. Los diferentes módulos de firmware deben ser desarrollados de forma que puedan comunicarse entre ellos sin que esto represente una dificultad.
	\item Probabilidad de ocurrencia (O): 5. Se hará el desarrollo de una forma modular, haciendo pruebas de cada una de las partes para comprobar su correcto funcionamiento.
\end{itemize}
