...
\begin{itemize}
	...
	\begin{itemize}
		...
		Prioridad: Alta. \textit{Story Points}: 8.
		\item \textbf{HU6:} como usuario final, quiero conocer el estado general del collar para saber el estado del mismo y tomar deciciones como cargar incluyendo batería, detectar un fallo o buscar a la mascota.\\
