...
\item Desarrollo del sistema remoto y visualización (90 h)
	...
	\end{enumerate}
\item Validación del prototipo (70 h)
	\begin{enumerate}
	...
	\item Pruebas de campo de geolocalización y autonomía (10 h)
	\end{enumerate}
\item Documentación y cierre (80 h)
	\begin{enumerate}
	\item Registro de resultados y análisis de ensayos (10 h)
...
En la figura \ref{fig:AoN} se muestra el diagrama preliminar de \textit{Activity on Node} correspondiente a la planificación del proyecto. El mismo resume las principales tareas y su relación de precedencia.
...
En la figura \ref{fig:diagGantt} se presenta el diagrama de Gantt preliminar del proyecto. Este cronograma resume la distribución temporal de las actividades principales y deberá mantenerse consistente con la fecha de finalización indicada en el acta constitutiva.
...
El presupuesto preliminar del proyecto se expresa en dólares estadounidenses (USD).
...
\begin{consigna}{red}
Seleccionar los requerimientos más críticos del proyecto e indicar para cada uno las acciones de verificación y validación que permitirán asegurar su cumplimiento.
