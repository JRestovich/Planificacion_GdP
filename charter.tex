...
Por medio de la presente se acuerda con el \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'' y consistirá en la implementación de un prototipo de un collar rastreador de mascotas. El trabajo tendrá un presupuesto preliminar estimado de \textcolor{red}{600} horas y un costo estimado de \textcolor{red}{\$ XXX}, con fecha de inicio el \fechaInicioName\hspace{1px} y fecha de presentación pública el \fechaFinalName.
...
Actualmente, hay competidores que ya ofrecen productos similares, pero que no logran imponerse en el mercado. Se pueden encontrar alternativas importadas de productos similares, pero ninguna de ellas está pensada para el mercado argentino y sus necesidades. Las opciones existentes que abordan esta problemática tienen 2 problemas principales, que podemos identificar en las siguientes categorías:

\begin{itemize}
	\item Las que son muy costosas. Hay soluciones cuyo costo de entrada es muy elevado o que requieren una suscripción mensual dolarizada, ya que se trata de un producto sin representación en el país.
...
\begin{itemize}
	...
	\item Orientador: el Esp. Ing. Gonzalo Sanchez brindará guía técnica y metodológica, colaborando en la revisión del enfoque general, la definición de prioridades y la validación de las decisiones de diseño.
...
\begin{consigna3}
Brindar una solución accesible para localizar mascotas extraviadas de manera rápida y confiable, mediante el desarrollo y validación de un prototipo con GPS y conectividad 4G que permita evaluar su factibilidad técnica para el mercado local
...
\begin{consigna4}
Para definir el alacance del proyecto nos vamos a restrigirlo para que el mismo sea compatible con la cantidad de horas requeridas para curso de Especialización. El proyecto se centra principalmente en el desarrollo del firmware y todos sus componentes necesarios. Para la culminación del proyecto tendremos un prototipo funcional y un dashboard básico.
...
\begin{itemize}
	\item Selección de componentes.
		...
		\item Selección de trajeta SD.
		\end{itemize}
	\item Diseńo del sistema.
	\item Selección de un provedor 4G IoT.
...
\begin{itemize}
	...
	\item El presupuesto será de USD 500 y estará a cargo del autor.
	\item El proyecto requerirá conocimientos que se adquirirán en la Especialización en Sistemas Embebidos.
	\item Se podrán adquirir los componentes de forma sencilla y las importaciones internacionales no serán un problema para su compra.
\end{itemize}
