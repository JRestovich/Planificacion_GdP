...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Presentar un prototipo ensamblado al cliente para que compruebe el peso y dimensiones del dispositivo para confirmar que son compatibles con el uso previsto en una mascota.
	\end{itemize}
