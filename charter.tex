...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item El dispositivo debe mantener dimensiones y peso compatibles con el uso en una mascota, dentro de las limitaciones propias de un prototipo.
	\end{enumerate}
	\item Requerimientos de validación:
	\begin{enumerate}
		\item Se realizarán pruebas unitarias de los componentes [rincipales de firmware.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		Prioridad: Alta. \textit{Story Points}: 8.
		\item \textbf{HU6:} Como usuario final, quiero conocer el estado general del collar, incluyendo batería, estado operativo y geolocalización.\\
...
\item Planificación y definición del proyecto (60 h)
	...
	\item Elaboración del backlog y criterios de aceptación (10 h)
...
El diagrama de \textit{Activity on Node} se armó a partir del WBS definido en la sección anterior. En la figura \ref{fig:AoN} se muestran las principales tareas del proyecto y sus relaciones de precedencia. Los tiempos indicados en el diagrama están expresados en horas.
...
En la figura \ref{fig:diagGantt} se presenta el diagrama de Gantt del proyecto. Este cronograma resume la distribución temporal de las actividades principales, muestra las tareas del EDT y deberá mantenerse consistente con la fecha de finalización indicada en el Acta Constitutiva.

\begin{landscape}
\begin{figure}[htpb]
\centering
\includegraphics[height=.85\textheight]{./Figuras/Gantt-2.png}
\caption{Diagrama de Gantt preliminar del proyecto.}
\label{fig:diagGantt}
\end{figure}
\end{landscape}
...
El presupuesto detallado del proyecto se expresa en dólares estadounidenses (USD). Para este proyecto se distinguen costos directos e indirectos, siguiendo el formato propuesto por la plantilla.
...
Plataforma de desarrollo embebida &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{USD 70} &
  \multicolumn{1}{c|}{USD 70} \\ \hline
Módulo GPS &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{USD 35} &
  \multicolumn{1}{c|}{USD 35} \\ \hline
Módulo 4G &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{USD 110} &
  \multicolumn{1}{c|}{USD 110} \\ \hline
Memoria microSD y adaptadores &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{USD 15} &
  \multicolumn{1}{c|}{USD 15} \\ \hline
Batería, cargador y protecciones &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{USD 60} &
  \multicolumn{1}{c|}{USD 60} \\ \hline
Materiales de prototipado, cableado y conectores &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{USD 80} &
  \multicolumn{1}{c|}{USD 80} \\ \hline
SIM y conectividad para pruebas &
  \multicolumn{1}{c|}{1} &
  \multicolumn{1}{c|}{USD 60} &
  \multicolumn{1}{c|}{USD 60} \\ \hline
\multicolumn{3}{|c|}{SUBTOTAL} &
  \multicolumn{1}{c|}{USD 430} \\ \hline
\rowcolor[HTML]{C0C0C0}
...
Descripción &
  ...
  \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}Valor unitario} &
  \multicolumn{1}{c|}{\cellcolor[HTML]{C0C0C0}Valor total} \\ \hline
Traslados y logística de pruebas de campo &
  \multicolumn{1}{c|}{1} &
...
Amortización de herramientas y recursos auxiliares &
  ...
  \multicolumn{1}{c|}{USD 50} \\ \hline
\multicolumn{3}{|c|}{SUBTOTAL} &
  \multicolumn{1}{c|}{USD 170} \\ \hline
\rowcolor[HTML]{C0C0C0}
\multicolumn{3}{|c|}{TOTAL} &
  \multicolumn{1}{c|}{USD 600} \\ \hline
\end{tabularx}
\end{table}
...
Riesgo 1: demoras en la adquisición de módulos importados.
\begin{itemize}
	\item Severidad (S): 8.
...
Riesgo 5: desvío en la carga horaria disponible del responsable.
\begin{itemize}
	\item Severidad (S): 6.
	\item Probabilidad de ocurrencia (O): 5.
\end{itemize}
...
Demoras en adquisición de módulos importados & 8 & 6 & 48 & 8 & 3 & 24 \\ \hline
Cobertura 4G insuficiente en pruebas & 7 & 5 & 35 & 6 & 4 & 24 \\ \hline
Autonomía menor a la esperada & 8 & 5 & 40 & 7 & 3 & 21 \\ \hline
Dificultades de integración entre subsistemas & 7 & 6 & 42 & 6 & 4 & 24 \\ \hline
Desvío de carga horaria disponible & 6 & 5 & 30 & 5 & 4 & 20 \\ \hline
\end{tabularx}
\end{table}
...
\begin{itemize}
	\item Para el riesgo de adquisición de módulos, se prevé seleccionar componentes con proveedores alternativos y adelantar las compras críticas.
	\item Para el riesgo de cobertura 4G insuficiente, se realizarán pruebas tempranas en distintas zonas y se evaluará más de un operador celular.
	\item Para el riesgo de autonomía insuficiente, se medirá el consumo por subsistema y se ajustará la estrategia de transmisión y adquisición de datos.
	\item Para el riesgo de integración, se planificarán ensayos incrementales por módulo antes de avanzar a la integración completa.
	\item Para el riesgo de desvío horario, se mantendrá una planificación con hitos intermedios y márgenes de contingencia.
\end{itemize}
...
Se seleccionan a continuación algunos de los requerimientos más críticos del proyecto, indicando para cada uno las acciones de verificación y validación previstas para asegurar su cumplimiento.

\begin{itemize}
	\item Req \#1: el sistema debe adquirir la ubicación geográfica mediante GPS.
	\begin{itemize}
		\item Verificación: contrastar lecturas del módulo contra puntos de referencia conocidos.
		\item Validación: confirmar que la precisión obtenida permite localizar a la mascota de forma práctica.
	\end{itemize}
	\item Req \#2: el sistema debe transmitir datos mediante red 4G y MQTT.
	\begin{itemize}
		\item Verificación: revisar logs de conexión, publicación y recepción en el broker.
		\item Validación: confirmar que el usuario puede visualizar la información remotamente en el dashboard.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	\item Revisión del cumplimiento del plan original: el responsable del proyecto realizará una comparación entre la planificación inicial y los resultados obtenidos, dejando registro de desvíos, causas y acciones correctivas adoptadas.
	\item Identificación de técnicas útiles, problemas encontrados y soluciones aplicadas: el responsable documentará las prácticas que resultaron efectivas, las que no aportaron valor y los principales problemas surgidos durante el desarrollo, junto con su resolución.
	\item Organización del cierre formal del proyecto y agradecimiento a los interesados: el responsable del proyecto organizará el cierre, incluyendo la comunicación final con el director y demás interesados relevantes. Los gastos menores asociados a esta instancia serán asumidos dentro del presupuesto general del proyecto.
\end{itemize}
