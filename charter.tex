...
\begin{longtable}{|C{0.7cm}|L{6.4cm}|C{1.8cm}|C{1.8cm}|C{1.2cm}|}
\rowcolor[HTML]{C0C0C0}
ID & Actividad & Fecha de inicio & Fecha de fin & Duración \\ \hline
\endfirsthead
\hline
\rowcolor[HTML]{C0C0C0}
ID & Actividad & Fecha de inicio & Fecha de fin & Duración \\ \hline
...
\captionof{figure}{Diagrama de Gantt del proyecto.}
\label{fig:diagGantt}
\end{landscape}
