...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Hacer una demostración al clientedonde se fuercen los distintos estados del equipo y se confirme que la señalización del LED y los datos del dashboard reflejan correctamente cada estado del collar.
	\end{itemize}
